<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Hata.aspx.cs" Inherits="Eticaret._3D.Hata"  enableViewStateMac="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentOrtaUrunler" runat="server">
     <h3> <asp:Label Text="" runat="server" ForeColor="#FF3300" ID="lblResult" /> </h3>
</asp:Content>
