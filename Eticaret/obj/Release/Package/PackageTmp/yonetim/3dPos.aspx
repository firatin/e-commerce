<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/AnaPage.Master" AutoEventWireup="true" CodeBehind="3dPos.aspx.cs" Inherits="Eticaret.yonetim._3dPos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table id="tbPosEkle" runat="server" visible="false" class="auto-style1">
        ...
        <tr>
            <td class="auto-style7">Üye İşyeri No(ClientId)</td>
            <td class="auto-style3">:</td>
            <td>
        ...
        <tr>
            <td class="auto-style11">ProvUserId</td>
            <td class="auto-style12">:</td>
            <td class="auto-style13">
                <asp:TextBox ID="txtProvUserId" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style11">TidUserId</td>
            <td class="auto-style12">:</td>
            <td class="auto-style13">
                <asp:TextBox ID="txtTidUserId" runat="server"></asp:TextBox>
            </td>
        </tr>
         <tr>
        ...
        <tr>
         ...
         <tr>
            <td class="auto-style11">Store Key</td>
            <td class="auto-style12">:</td>
            <td class="auto-style13">
                <asp:TextBox ID="txtStoreKey" runat="server"></asp:TextBox>
             </td>
        </tr>
         <tr>
            <td class="auto-style11">Store Password</td>
            <td class="auto-style12">:</td>
            <td class="auto-style13">
                <asp:TextBox ID="txtStorePw" runat="server"></asp:TextBox>
             </td>
        </tr>
        <tr>
                    ...
                    <asp:Repeater ID="RpKayit" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("Banka")%></td>
                                <td><%#Eval("Durumadi")%></td>
                                <td><a href="3dPos.aspx?Banka=<%#Eval("PosId")%>&islem=duzenle" title="Düzenle"><i class="icon-pencil"></i></a></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
