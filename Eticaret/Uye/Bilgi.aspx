<%@ Page Title="" Language="C#" MasterPageFile="~/Uye/UyeMaster.master" AutoEventWireup="true" CodeBehind="Bilgi.aspx.cs" Inherits="Eticaret.Uye.Bilgi" %>
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddil" runat="server" AutoPostBack="True" Height="33px" OnSelectedIndexChanged="ddil_SelectedIndexChanged" TabIndex="15" Width="158px">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td style="height: 25px">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddilce" runat="server" AutoPostBack="True" Height="33px" TabIndex="16" Width="158px">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
